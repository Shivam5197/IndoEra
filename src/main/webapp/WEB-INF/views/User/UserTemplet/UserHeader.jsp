...
<link type="text/css" href="<c:url value="/CSS/Header/header.css"/>" rel="stylesheet">
<link type="text/css" href="<c:url value="/CSS/Header/loader.css"/>" rel="stylesheet">
...
<nav class="navbar navbar-expand-lg navbar-light navBacground">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
<!--     <a href="/store/storeFormshow" class="btn"><b>Add Store</b></a> -->
      </li>
